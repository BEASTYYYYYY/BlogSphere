...
// This is crucial for serverless environments like Vercel which have read-only file systems.
// The file will be available as a Buffer in req.file.buffer
const storage = multer.memoryStorage();
const upload = multer({ storage: storage }); // - Original line `const upload = multer({ dest: 'uploads/' });` is changed here.
...
// Ensure uploadImage in blogController.js uses req.file.buffer, not req.file.path
// as memoryStorage will provide a buffer.
